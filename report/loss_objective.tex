...
\newcommand{\LossWeightFn}{w_j(y)\;\propto\;\hat{p}_j(y)^{-\alpha},\qquad w_j \in \left[\tfrac{1}{c},\, c\right],\qquad \frac{1}{\lvert \mathcal{I}_j \rvert}\sum_{i \in \mathcal{I}_j} w_j\!\left(y_{ij}\right)\;=\;1}
\newcommand{\LossDensity}{\hat{p}_j\;=\;\text{Gaussian KDE fitted on }\left\{\, y_{ij} \;:\; i \in \mathcal{I}_j \,\right\}}
\newcommand{\LossArms}{\ell \in \{\text{squared},\, \text{absolute},\, \text{Huber}_\beta\},\qquad \alpha \in \{\text{off},\, \tfrac{1}{2},\, 1\}}
