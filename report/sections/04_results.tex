...
\midrule
MLP, unweighted            & 0.320 & \textbf{0.377} & 0.0264 & 0.0254 \\
...
The ridge control behaves as on every previous panel: it ties the PCA model ($0.306$ against $0.320$),
...
bit-reproducible: three executions of identical code and seed gave $0.313$, $0.317$ and $0.320$, while
