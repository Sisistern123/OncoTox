...
\midrule
MLP, unweighted            & 0.313 & \textbf{0.377} & 0.0266 & 0.0254 \\
...
The ridge control behaves as on every previous panel: it ties the PCA model ($0.306$ against $0.313$),
...
without reference to our labels. Absolute correlations are lower than on the earlier panel ($0.377$ against
