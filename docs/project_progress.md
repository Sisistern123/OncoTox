...
| Drug selection | ⛔ **VOID 28.07.2026 — rebuild pending** | 8 compounds, each with a published cell-line sensitivity determinant. Reproducible by citation; the old 0.5/0.8 thresholds were unstable (0.7/0.8 gave a different ten). ⚠️ literature-anchored and spread-verified, **not label-blind** ([Step 05](./steps/05-multitask-results.md)) |
